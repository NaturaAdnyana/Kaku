...
const bannerActionButtonClass =
  "absolute z-10 flex items-center gap-2 rounded-base border-2 border-border bg-main px-4 py-2 text-main-foreground shadow-[2px_2px_0_var(--border)] transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none active:translate-x-[2px] active:translate-y-[2px]";
...
function KanjiSVG({ svgContent }: { svgContent: string }) {
  ...
  return (
    <div className="relative group/svg flex flex-col items-center">
      ...
      />
      <div className="absolute top-1/2 right-[-3rem] z-10 -translate-y-1/2">
        <button
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "absolute inset-0 flex flex-col items-center justify-center bg-blank border-2 border-border rounded-base shadow-[6px_6px_0_var(--border)] group-hover:translate-x-[-2px] group-hover:translate-y-[-2px] group-hover:shadow-[8px_8px_0_var(--border)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-[2px_2px_0_var(--border)] transition-all text-center box-border p-6",
            "[backface-visibility:hidden]",
          )}
        >
          <div
            className={cn(
              "flex items-center justify-center font-medium tracking-tighter mb-2",
              fontSize,
            )}
          >
            {decodedWord}
        ...
        <div
          className={cn(
            "absolute inset-0 flex flex-col items-center justify-center w-full h-full bg-blank border-2 border-border rounded-base shadow-shadow text-center box-border p-6",
        ...
        >
          ...
          <Link
            ...
            onClick={(e) => e.stopPropagation()}
            className={cn(bannerActionButtonClass, "bottom-4 right-4")}
